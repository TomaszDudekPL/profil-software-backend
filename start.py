...
@click.option('--popular_cities', help='The most popular cities. Commands: any number.')
@click.option('--popular_passwords', help='The most popular password. Commands: any number.')
